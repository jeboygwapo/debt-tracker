...
from .routes import admin as admin_routes, auth, budget as budget_routes, goals as goals_routes, notifications as notifications_routes, pages, api as api_routes, debts as debts_routes
